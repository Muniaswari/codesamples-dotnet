...
public class CreateRecurringPaymentsProfileSample
{
    // # Static constructor for configuration setting
    static CreateRecurringPaymentsProfileSample()
    {
    ...
    private static ILog logger = LogManager.GetLogger(typeof(CreateRecurringPaymentsProfileSample));
